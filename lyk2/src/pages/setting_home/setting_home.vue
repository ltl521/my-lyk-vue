    ...
    <section>
      ...
      <div class="user-service-gj">
        <ul>
          <li>
            <!--未认证-->
            <router-link to="/certification" class="My-tp1-gj" id="My-tp1-gj-id">商户认证<i class="" id="verified">{{IsVerified}}</i>
            </router-link>
            <!--已认证-->
            <!--<router-link to="/certification" class="My-tp1-gj" id="My-tp1-gj-id">商户认证<i class="" id="verified">&lt;!&ndash;{{IsVerified}}&ndash;&gt;</i>
            </router-link>-->
          </li>
          <li>
            <!--未设置-->
            <!--<router-link to="/draw_cash_pwd" class="My-tp2-gj" id="My-tp2-gj">提现<i class="" id="verified2">{{verified}}</i></router-link>-->
            <!--已设置-->
            <router-link to="/draw_cash" class="My-tp2-gj" id="My-tp2-gj">提现<i class="" id="verified2"><!--{{verified}}--></i></router-link>
          </li>
          <li>
            <router-link class="My-tp3-gj" to="/message_history" id="My-tp3-gj">消息中心<i class="news-tp-gj"></i>
            </router-link>
          </li>
          <li class="add-mar1-gj">
            <router-link class="My-tp4-gj" to="/setting_kefu" id="add-mar1-gj">客服中心</router-link>
          </li>
          <li>
            <router-link class="My-tp5-gj" to="/setting_security">安全设置</router-link>
          </li>
        </ul>
        <div class="tcdl" @click="logOff()">退出登录</div>
      </div>
    </section>
    <foot></foot>
    <!--错误提示-->
